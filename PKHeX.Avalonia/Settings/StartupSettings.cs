...
/// <summary>
/// Mirrors the WinForms <c>StartupSettings</c> (JSON compatible).
/// </summary>
public sealed class StartupSettings : IStartupSettings
{
    ...
    public bool DarkMode { get; set; } // initialized from the system theme for new settings, json load preserves any choice.
    ...
    public bool HighDpiText { get; set; } // WinForms only; retained for config compatibility.
    ...
    } = Localization.CultureUtil.GetCultureLanguage();
