// Location names copied verbatim from the WinForms SAV_ZygardeCell form.
namespace PKHeX.Avalonia.Views.SaveEditors.Gen7;

/// <summary>
/// Where each Zygarde cell is found, in dex order, per game pair.
/// </summary>
public static class ZygardeCellLocations
{
    ...
    public static readonly string[] USUM =
    [
